...
#+REVEAL_HTML: <div class="column" style="float: left; width: 100%; margin:auto; font-size: 140%;">
*Perspectives 2024-2023 :*
+ Lancement de *RTTOV v14* début *2024*
 - Gel du code *fin mai 2023*
 - Redéfinition des propriétés atmosphériques @@html:&#8594@@ *couches* /versus/ *niveaux*
 - Recalcul des *bases de transmittances*
 - Refonte de l'interface utilisateurs @@html:&#8594@@ fort impact *RTTOV-GUI*
...
[[../fig/option.png]]
#+REVEAL_HTML: </div>
#+REVEAL_HTML: <div class="column" style="float:left; width:39%">
#+ATTR_HTML: :border yes :width 100% :margin auto
[[../fig/exemple.png]]
#+REVEAL_HTML: </div>
#+REVEAL_HTML: <div class="column" style="float:left; width:30%">
...
#+REVEAL_HTML: </div>
#+BEGIN_EXPORT html
<p>Check out <a href="https://sounding.trainhub.eumetsat.int/" target="_blank" rel="noopener noreferrer">Wess4t application</a>.</p>
#+END_EXPORT
#+REVEAL_HTML: </div>
